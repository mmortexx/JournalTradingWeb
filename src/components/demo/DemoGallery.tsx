              ...
              >
                ...
                >
                  <div className="relative transition-transform duration-[600ms] ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.02]">
                    ...
                    <span
                      aria-hidden
                      className="absolute top-2 right-2 z-10 inline-flex items-center justify-center w-7 h-7 rounded-md bg-black/45 backdrop-blur-sm backdrop-saturate-150 border border-[rgb(var(--divider)/0.20)] text-[#F3EEE2]/90 opacity-60 md:opacity-0 md:translate-y-1 md:group-hover:opacity-100 md:group-hover:translate-y-0 transition-[opacity,transform] duration-200"
                    >
