            ...
            <Reveal key={h.slug} delay={i * 0.04} className="h-full">
              <li className="h-full">
                <Link
                  ...
                  className="tj-paper group flex h-full flex-col rounded-[2px] border border-[rgb(var(--divider)/0.13)] p-5 transition-colors duration-200 hover:border-[rgb(var(--accent-base)/0.35)]"
                >
                  <span
